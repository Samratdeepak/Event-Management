		...
		<div
			...
			<div class="col-6">
				<img class="img-fluid" style="height: 400px; width: 1000px;" alt=""
					src="https://aaft.com/blog/wp-content/uploads/2024/03/46268-1024x683.jpg">
			</div>
		</div>
		<div
			class="row featurette d-flex justify-content-center align-items-center">
			...
			<div class="col-6 order-1">
				<img class="img-fluid" style="height: 400px; width: 100%;"
					src="https://media.istockphoto.com/id/1340256496/photo/shot-of-a-young-woman-decorating-a-table-with-place-card-holders-in-preparation-for-a-wedding.jpg?s=612x612&w=0&k=20&c=gBQHa3_HywGsZv4MYRfvMpWAsgLLUkQvyMbG-lHBOSo="
					alt="">
			</div>
		</div>
		<div
			...
			<div class="col-md-6">
				<img class="img-fluid" style="height: 400px; width: 900px;"
					src="https://eventsolutions.com/wp-content/uploads/2016/07/Party-Under-the-Space-Shuttle-Endeavour-1030x687.jpg.webp"
					alt="">
			</div>
		</div>
	</div>
